    ...
    <>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0;}
        body{background:linear-gradient(135deg,#ecfeff 0%,#d9f99d 55%,#fef3c7 100%);}
        ...
        .orb1{position:absolute;width:520px;height:520px;background:radial-gradient(circle,rgba(6,182,212,0.25) 0%,transparent 70%);top:-180px;right:-120px;pointer-events:none;}
        ...
        .card{background:#ffffff;border:2px solid rgba(15,23,82,0.35);border-radius:28px;padding:44px 38px;width:100%;max-width:440px;position:relative;box-shadow:0 32px 80px rgba(30,58,138,0.08);}
