...
export default function AdminDashboard() {
  ...
  const S = {
    ...
    topbar:{background:'linear-gradient(135deg,#ecfeff 0%,#d9f99d 30%,#fef3c7 100%)',backdropFilter:'blur(16px)',borderBottom:'2px solid rgba(15,23,82,0.35)',padding:'0 32px',height:64,display:'flex',alignItems:'center',justifyContent:'space-between',position:'sticky' as const,top:0,zIndex:10,boxShadow:'0 10px 30px rgba(30,58,138,0.08)'},
    ...
    <>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        .sc{background:#ffffff;border:2px solid rgba(15,23,82,0.35);border-radius:20px;padding:24px;box-shadow:0 18px 40px rgba(30,58,138,0.08);}
        .sl{font-size:11px;font-weight:600;letter-spacing:0.08em;text-transform:uppercase;margin-bottom:10px;color:#64748b;}
        .sv{font-family:'Playfair Display',serif;font-size:32px;font-weight:700;line-height:1;color:#0f172a;}
        ...
        .fbtn{padding:8px 18px;border-radius:20px;font-size:12px;font-weight:600;cursor:pointer;border:2px solid rgba(15,23,82,0.35);background:#f8fafc;color:#475569;font-family:'DM Sans',sans-serif;transition:all 0.2s;}
        .fbtn.on{background:rgba(6,182,212,0.14);border-color:rgba(6,182,212,0.28);color:#0c4a6e;}
        .tscroll{overflow-x:auto;}
        table{width:100%;border-collapse:collapse;}
        thead{background:#f8fafc;}
        th{padding:14px 14px;font-size:11px;font-weight:700;color:#64748b;letter-spacing:0.08em;text-transform:uppercase;border-bottom:2px solid rgba(15,23,82,0.35);white-space:nowrap;text-align:center;}
        th.tl{text-align:left;padding-left:18px;}
        td{padding:15px 14px;border-bottom:1px solid rgba(226,232,240,0.8);text-align:center;vertical-align:middle;color:#0f172a;}
        td.tl{text-align:left;padding-left:18px;}
        tr:last-child td{border-bottom:none;}
        tr:hover td{background:#f8fbff;}
        .mname{font-weight:700;color:#0f172a;font-size:14px;}
        .memail{color:#64748b;font-size:12px;margin-top:2px;}
        .nc{color:#475569;font-size:13px;}
        .rsel{background:#f8fafc;border:2px solid rgba(15,23,82,0.35);border-radius:12px;padding:8px 12px;color:#0f172a;font-size:13px;font-family:'DM Sans',sans-serif;outline:none;cursor:pointer;}
        .rsel option{background:#ffffff;color:#0f172a;}
        .badge{padding:5px 12px;border-radius:999px;font-size:11px;font-weight:700;color:#0f172a;background:#eff6ff;}
        ...
        .ab{padding:8px 14px;border-radius:12px;font-size:12px;font-weight:700;cursor:pointer;border:none;font-family:'DM Sans',sans-serif;transition:all 0.15s;}
        ...
        .cs{background:#ffffff;border:2px solid rgba(15,23,82,0.35);border-radius:10px;padding:9px 13px;color:#0f172a;font-size:13px;font-family:'DM Sans',sans-serif;outline:none;cursor:pointer;}
        .cs option{background:#ffffff;color:#0f172a;}
        .ainfo{font-size:12px;color:#64748b;}
        .dot-h{width:28px;height:28px;background:#d1fae5e;border:1.5px solid rgba(34,197,94,0.45);border-radius:50%;display:flex;align-items:center;justify-content:center;margin:0 auto;font-size:12px;color:#166534;font-weight:700;}
        .dot-a{width:28px;height:28px;background:#f8fafc;border:1px solid rgba(203,213,225,0.8);border-radius:50%;display:flex;align-items:center;justify-content:center;margin:0 auto;font-size:11px;color:#94a3b8;}
        .tot-badge{background:#cffafe;color:#0c4a6e;border:1px solid rgba(6,182,212,0.22);padding:4px 10px;border-radius:20px;font-size:12px;font-weight:600;}
      ...
      <div style={S.layout}>
        <div style={S.topbar}>
          ...
          <button style={{background:'rgba(34,197,94,0.12)',border:'1px solid rgba(34,197,94,0.22)',color:'#0b6623',padding:'8px 16px',borderRadius:10,fontSize:13,cursor:'pointer',fontFamily:"'DM Sans',sans-serif"}}
