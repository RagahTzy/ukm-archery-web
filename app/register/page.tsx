    ...
    <>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        .orb1{position:absolute;width:320px;height:320px;background:radial-gradient(circle,rgba(14,165,233,0.24) 0%,transparent 70%);top:-90px;right:-60px;pointer-events:none;}
        ...
        .card{background:#ffffff;border:2px solid rgba(15,23,82,0.35);border-radius:28px;padding:32px 24px;width:100%;max-width:500px;position:relative;box-shadow:0 32px 80px rgba(30,58,138,0.08);}
